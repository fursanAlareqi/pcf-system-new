                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="card-title"> اضافة تقييم شهري </div>
                                        </div>
                                        <div class="card-body">
                                            <div class="row">
	...
	if(isset($_POST['save'])){
        ...
        $sender_name=$name['name'];
         ...
         if (!in_array($file_name_expload_end1, $exti)) {
                ...
                $query="INSERT INTO evaluation_form(sender_name,branch,file,emp)
                values (?,?,?,?) ";
                $stm=$con->prepare($query);
                $stm->execute(array($user,$branch,$file_name1,$emp));
                if($stm->rowCount())
                {
                    move_uploaded_file($file_tmp1,"evaluation/".$file_name1);
