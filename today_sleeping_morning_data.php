							...
							<form action="" method="post">
								<div class="card">
									<div class="card-header">
										<div class="card-title">  البيانات المدخلة لليوم صباح</div>
								...
								$sql="SELECT * FROM sleeping_morning where sender_name =? and date_data_come=?     ";	
...
WHERE code = ? AND type = ?    ";	
																...
																<td>
														<a href="sleeping_morning_edit.php?action=edit&ids=<?php echo $row['id'] ?>" >  
