					...
					<form action="" method="post">
						<div class="card">
							<div class="card-header">
								<div class="card-title">البيانات المدخلة قسم الطبيب النفسي</div>
								<?php
								include_once "include/query.php";
								include_once "include/table_actions.php";
								delete($con, 'psyshological');
								?>
							...
							<div class="card-body">
								...
								<?php
								$stmu = queryWithPagination($con, "psyshological");
								// // find branch
								...
								// $sql = "SELECT * FROM psyshological where Date(date_data_come) >= ? order by date_data_come desc   ";
