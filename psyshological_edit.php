								...
								<form action="" method="post">
									<div class="card">
										<div class="card-header">
											<div class="card-title"> تعديل بيانات الطبيب النفسي</div>
										</div>
										<div class="card-body">
											<div class="row">
												...
												<div class="col-md-6 col-lg-4">
													...
													<!--		<select class="selectpicker form-control" name="sub_diagnosis" id="tokens"  data-live-search="true" required >-->
...
<?php
	...
	if (isset($_POST['save'])) {
		...
		//اذا لايوجد اي مشكلة يقوم بارسال الملف
			...
			Suicide_Homicide=?,Speech=?,Thinking=?,Perception=?,Insight=?,lap=?,appraisal=?,quantity=? where id=?";
			...
			if ($stm->rowCount()) {
				...
				echo "<script>
				window.open('today_psyshological_data.php?num=5&id=2','_self')
		 		 </script>";
			} else {
