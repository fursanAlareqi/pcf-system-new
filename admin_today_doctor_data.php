					...
					<form action="" method="post">
						<div class="card">
							<div class="card-header">
								<div class="card-title">البيانات المدخلة قسم الطبيب العام</div>
								<?php
							...
							<div class="card-body">
								...
								<?php
								$stmu = queryWithPagination($con, "doctor");
								// // find branch
								...
								// $sql = "SELECT * FROM doctor where Date(date_data_come) >= ?  order by date_data_come desc";
