							...
							<form action="" method="post">
								<div class="card">
									<div class="card-header">
										<div class="card-title">  خدمة فيسبوك  </div>
									</div>
									<div class="card-body">
										<div class="row">
	...
	if(isset($_POST['save'])){
		...
		$f_sex=0;
			...
			else
			{
					...
					$query="INSERT INTO facebook(branch,date,
					phone,sex,sender_name,detals)
					values (?,?,?,?,?,?) ";
					$stm=$con->prepare($query);
					$stm->execute(array($branch,$date,$phone,$sex,$user,$detals ));
					if($stm->rowCount())
					{
