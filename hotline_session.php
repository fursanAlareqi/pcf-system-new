							...
							<form action="" method="post">
								<div class="card">
									<div class="card-header">
										<div class="card-title">    جلسة توعية  </div>
									</div>
									<div class="card-body">
										<div class="row">
                                            ...
                                            <div class="col-md-6 col-lg-4">
                                                ...
                                                <div class="form-group form-floating-label">
													...
													<input  type="text" class="form-control input-border-bottom" id="inputFloatingLabel" name="section_type"  required >
												</div>
											...
											<div class="col-md-6 col-lg-4">
											    ...
											    <div class="form-group">
													<label for="comment">محاور الجلسة</label>
													<textarea class="form-control" id="comment" name="detals" rows="5">
	...
	if(isset($_POST['save'])){
		...
		$detals=test_input($_POST["detals"]);
			...
			else
			{
					...
					$sql="select * from hotline_session where  code=? and date=? ";
					$stm=$con->prepare($sql); 
					...
					if($stm->rowCount()){
						...
						$query="INSERT INTO hotline_session(branch,date,
						code,section_type,sender_name,detals)
						values (?,?,?,?,?,?) ";
						$stm=$con->prepare($query);
						$stm->execute(array($branch,$date,$code,$section_type,$user,$detals));
						if($stm->rowCount())
						{
