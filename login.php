...
<body>
  ...
  <div class="container">
    ...
    <div class="cover">
      <div class="front">
        <img src="assets\img\pcf2.png" alt="">
...
if(isset($_POST["login"])){
    ...
    if($stm->rowCount()>0){
            ...
            if(password_verify($password, $element['password'])){
             ...
             //print_r( $_SESSION['user']);
			  ...
			  echo "<script>
				...
				echo '<script>swal("خطاء في كلمة السر", "        ", {
					icon : "warning",
					buttons: {        			
					  confirm: {
            ...
            echo '<script>swal("  هذا الحساب تم ايقافة", "        ", {
                icon : "warning",
                buttons: {        			
                  confirm: {
                    className : "btn btn-warning"
				...
				echo '<script>swal("  لم يتم تسجيل الدخول", "        ", {
					icon : "warning",
					buttons: {        			
					  confirm: {
						className : "btn btn-warning"
