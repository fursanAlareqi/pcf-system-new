          ...
          <div class="sidebar-wrapper scrollbar scrollbar-inner">
            <div class="sidebar-content">
              ...
              <ul class="nav nav-primary">
                ...
                <li class="nav-item <?php  if($id==21)echo 'active submenu' ?>">
                    <a data-toggle="collapse" href="<?php 
                      echo '#end';

                    ?>">
                      <i class="fas fa-grin-alt"></i>
                      <p>   اجراءات التقديم لمشروع <br>  مركز الدعم النفسي </p>
                      <span class="caret"></span>
                    </a>
                    <div class="collapse <?php if($id==21) echo 'show' ?>" id="end">
                      ...
                      <?php 
                          ...
                          if($stm->rowCount()==0){
                          ?>
                        <li <?php if($num==1&&$id==21) echo'class="active"'?>>
                            <a href="Ending_service.php?num=1&id=21">
                              <span  class="sub-item">اشعار انهاء خدمة</span>
                            </a>
                        </li>
                        <?php } ?>
                        ...
                        <?php 
                          $sql="select * from forms where  sender_name=? and auth=? and step=? and send=?";
                          $stm=$con->prepare($sql); 
                          $stm->execute(array($_SESSION['user']['id'],'True',"تقييم",'False'));
                          if($stm->rowCount()==0){
                            $sql="select * from forms where  sender_name=? and auth=? and step=? and send=?";
                            $stm=$con->prepare($sql); 
                            $stm->execute(array($_SESSION['user']['id'],'True',"انهاء خدمة",'False'));
                            if($stm->rowCount()){
                          ?>
                          <li <?php if($num==2&&$id==21) echo'class="active"'?>>
                          <a href="appraisal_form.php?num=2&id=21">
                              <span  class="sub-item"> التقييم</span>
                            </a>
                          </li>
                        <?php }else{ ?>
                            <li <?php if($num==2&&$id==21) echo'class="active"'?>>
                        ...
                        <?php 
                          $sql="select * from forms where  sender_name=? and auth=? and step=? and send=?";
                          $stm=$con->prepare($sql); 
                          $stm->execute(array($_SESSION['user']['id'],'True',"اخلاء عهدة",'False'));
                          if($stm->rowCount()==0){
                            $sql="select * from forms where  sender_name=? and auth=? and step=? and send=?";
                            $stm=$con->prepare($sql); 
                            $stm->execute(array($_SESSION['user']['id'],'True',"تقييم",'False'));
                            if($stm->rowCount()){
                          ?>
                          <li <?php if($num==3&&$id==21) echo'class="active"'?>>
                            <a href="guardianship_form.php?num=3&id=21">
                              <span  class="sub-item"> اخلاء عهدة عينية</span>
                            </a>
                          </li>
                        <?php }else{ ?>
                            <li <?php if($num==3&&$id==21) echo'class="active"'?>>
                        ...
                        <?php 
                          $sql="select * from forms where  sender_name=? and auth=? and step=? and send=?";
                          $stm=$con->prepare($sql); 
                          $stm->execute(array($_SESSION['user']['id'],'True',"اخلاء طرف",'False'));
                          if($stm->rowCount()==0){
                            $sql="select * from forms where  sender_name=? and auth=? and step=? and send=?";
                            $stm=$con->prepare($sql); 
                            $stm->execute(array($_SESSION['user']['id'],'True',"اخلاء عهدة",'False'));
                          ...
                          ?>
                          <li <?php if($num==3&&$id==21) echo'class="active"'?>>
                            <a href="side_form.php?num=3&id=21">
                              <span  class="sub-item"> اخلاء طرف </span>
                            </a>
                          </li>
                        <?php }else{ ?>
                            <li <?php if($num==3&&$id==21) echo'class="active"'?>>
                        ...
                        <?php }} ?>
                          ...
                          $sql="select * from forms where  sender_name=? and auth=? and step=? and send=?";
                          $stm=$con->prepare($sql); 
                          $stm->execute(array($_SESSION['user']['id'],'True',"مخالصة خدمة",'False'));
                          if($stm->rowCount()==0){
                            $sql="select * from forms where  sender_name=? and auth=? and step=? and send=?";
                            $stm=$con->prepare($sql); 
                            $stm->execute(array($_SESSION['user']['id'],'True',"اخلاء طرف",'False'));
                          ...
                          ?>
                          <li <?php if($num==3&&$id==21) echo'class="active"'?>>
                            <a href="Various_form.php?num=3&id=21">
                              <span  class="sub-item">اشعار مخالصة خدمة</span>
                            </a>
                          </li>
                        <?php }else{ ?>
                            <li <?php if($num==3&&$id==21) echo'class="active"'?>>
                        ...
                        <?php 
                          $sql="select * from forms where  sender_name=? and auth=? and step=? and send=? ";
                          $stm=$con->prepare($sql); 
                          $stm->execute(array($_SESSION['user']['id'],'True','سس','False'));
                          if($stm->rowCount()){
                          ?>
                          <li <?php if($num==4&&$id==21) echo'class="active"'?>>
                            <a href="certificate_form.php?num=4&id=21">
                              <span  class="sub-item">الشهادة</span>
                            </a>
                          </li>
                        <?php }else{ ?>
                            <li <?php if($num==4&&$id==21) echo'class="active"'?>>
                        ...
                        <?php 
                          ...
                          if($stm->rowCount()){
                          ?>
                          <li <?php if($num==5&&$id==21) echo'class="active"'?>>
                            <a href="offer_form.php?num=5&id=21">
                              <span  class="sub-item">التقديم</span>
                            </a>
                          </li>
                        <?php }else{ ?>
                            <li <?php if($num==5&&$id==21) echo'class="active"'?>>
              ...
              <?php if($_SESSION['user']['rule_id']== 5||$_SESSION['user']['rule_id']==2 ||$_SESSION['user']['rule_id']==6){ ?>
                ...
                <?php }?>
                <?php if($_SESSION['user']['rule_id']==9||$_SESSION['user']['rule_id']==15||$_SESSION['user']['rule_id']==18||$_SESSION['user']['rule_id']==2 ||$_SESSION['user']['rule_id']==6||$_SESSION['user']['rule_id']==20){ ?>
                <li class="nav-item <?php  if($id==7)echo 'active submenu' ?>">
                  <a data-toggle="collapse" href="
                  <?php 
                  if($_SESSION['user']['rule_id']==9||$_SESSION['user']['rule_id']==15||$_SESSION['user']['rule_id']==18||$_SESSION['user']['rule_id']==2 ||$_SESSION['user']['rule_id']==6||$_SESSION['user']['rule_id']==20){
                    echo '#sei';
                  }
                ...
                <li class="nav-item <?php  if($id==100)echo 'active submenu' ?>">
                  ...
                  <div class="collapse <?php if($id==100) echo 'show' ?>" id="Hotline">
                    ...
                    <li <?php if($num==110&&$id==100) echo'class="active"'?>>
                      ...
                      </li><li <?php if($num==113&&$id==100) echo'class="active"'?>>
