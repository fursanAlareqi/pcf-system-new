										...
										<div class="col-md-6 col-lg-4">
												...
												<div class="form-group form-floating-label">
													...
													<div class="form-group form-floating-label">
														...
														<input  type="number" value="<?php echo $row['code']; ?>" disabled class="form-control input-border-bottom" id="inputFloatingLabel" name="code"  required >
														
													</div>
													<div class="form-group form-floating-label">
														<label >تاريخ الميلاد</label>
														<input  type="date" value="<?php echo $row['date']; ?>" class="form-control input-border-bottom" id="inputFloatingLabel" name="brithday"  required >
													</div>
												...
												<div class="form-group form-floating-label">
													...
													<input  type="date" value="<?php echo $row['date_come']; ?>" class="form-control input-border-bottom" id="inputFloatingLabel" name="date_come"  required >
												</div>
											...
											<div class="col-md-6 col-lg-4">
												...
												<div class="form-group form-floating-label">
													...
													<input  type="tel" value="<?php echo $row['phone']; ?>" class="form-control input-border-bottom" id="inputFloatingLabel" name="phone" pattern="[7]{1}[7,1,3,0]{1}[0-9]{7}"  required >
												</div>
												<div class="form-group form-floating-label">
													<label >استشاره/معاينة</label>
														<select class="selectpicker form-control"  id="tokens ddd"  data-live-search="true" name="view" required  >
															<option ></option>
															<option value="استشارة"<?php if( $row['view'] == "استشارة") echo "selected" ?>  >استشارة</option>
															<option value="معاينة" <?php if( $row['view'] == "معاينة") echo "selected" ?>>معاينة</option>
															<option value=">جلسة دعم نفسي" <?php if( $row['view'] == "جلسة دعم نفسي") echo "selected" ?> >جلسة دعم نفسي</option>
														</select>
 												</div>
												 <div class="form-group form-floating-label">
												...
												<div class="form-group form-floating-label">
													...
													<input  type="text" value="<?php echo $row['becouse_come']; ?>" class="form-control input-border-bottom" id="inputFloatingLabel" name="becouse_come"  required >
												</div>
												...
												<div class="form-group form-floating-label">
													...
													<input  type="number" value="<?php echo $row['daughter']; ?>" class="form-control input-border-bottom" id="inputFloatingLabel" name=""   >
	...
	$f_sex=0;
		...
		else
		{
				...
				place=?,social_status=?,department=?,isolation=?,villag=?,briefness=?,
				  becouse_come=?,date_come=?,studing=?,identity=?,
				   identity_number=?,identity_place=?,laying=?,brother=?,work=?,
					...
					sister=?,know_our=?,sender_name=?,view=?,type=? where id=?
				 ";
				$stm=$con->prepare($query);
				$stm->execute(array($branch,$name,$brithday,$date,$phone,$brithday_blace,$sex,$place,
				$social_status,$department,$isolation,$villag,$briefness
				 ...
				 $know_our,$user,$view,$row['type'], $id));
				if($stm->rowCount())
				{
