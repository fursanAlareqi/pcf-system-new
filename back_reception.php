												...
												<div class="col-md-6 col-lg-4">
													...
													<div class="form-group form-floating-label">
														...
														<div class="form-group form-floating-label">
															...
															<input type="tel" value="<?php echo $row['phone']; ?>" class="form-control input-border-bottom" id="inputFloatingLabel" name="phone" pattern="[7]{1}[7,1,3,0,8]{1}[0-9]{7}">
														</div>
														<div class="form-group form-floating-label">
														...
														<div class="form-group form-floating-label">
															...
															<input type="text" value="<?php echo $row['name']; ?>" class="form-control input-border-bottom" id="inputFloatingLabel" name="name">
														</div>
														<div class="form-group form-floating-label">
															<label>مكان الميلاد</label>
															<input type="text" value="<?php echo $row['brithday_blace']; ?>" class="form-control input-border-bottom" id="inputFloatingLabel" name="brithday_blace">
														</div>
														<div class="form-group form-floating-label">
															<label>عدد الاخوة الذكور </label>
															<input type="number" value="<?php echo $row['brother']; ?>" class="form-control input-border-bottom" id="inputFloatingLabel" name="brother">
														</div>
														<div class="form-group form-floating-label">
															<label>عدد الاخوة الاناث </label>
															<input type="number" value="<?php echo $row['sister']; ?>" class="form-control input-border-bottom" id="inputFloatingLabel" name="sister">
														</div>
														<div class="form-group form-floating-label">
															<label> ترتيبة بين الاخوة</label>
															<input type="text" value="<?php echo $row['laying']; ?>" class="form-control input-border-bottom" id="inputFloatingLabel" name="laying">
												...
												<div class="col-md-6 col-lg-4">
													...
													<div class="form-group form-floating-label">
														...
														<select class="selectpicker form-control" id="tokens ddd" data-live-search="true" name="identity">
															<option></option <option value="بطاقة شخصية" <?php if ($row['identity'] == "بطاقة شخصية") echo "selected" ?>>بطاقة شخصية</option>
													...
													<div class="form-group form-floating-label">
														...
														<input type="number" value="<?php echo $row['identity_number']; ?>" class="form-control input-border-bottom" id="inputFloatingLabel" name="identity_number">
													</div>
													<div class="form-group form-floating-label">
														<label>مكان صدورها</label>
														<input type="text" value="<?php echo $row['identity_place']; ?>" class="form-control input-border-bottom" id="inputFloatingLabel" name="identity_place">
													</div>
													<div class="form-group form-floating-label">
													...
													<div class="form-group form-floating-label">
														...
														<select class="selectpicker form-control" id="tokens ddd" data-live-search="true" name="briefness">
															<option></option>
															...
															<option <?php if ($row['briefness'] == "لحج") echo "selected" ?>>لحج </option>
													...
													<div class="form-group form-floating-label">
														...
														<input type="text" value="<?php echo $row['department']; ?>" class="form-control input-border-bottom" id="inputFloatingLabel" name="department">
													</div>
													<div class="form-group form-floating-label">
														<label>العزله</label>
														<input type="text" value="<?php echo $row['isolation']; ?>" class="form-control input-border-bottom" id="inputFloatingLabel" name="isolation">
													</div>
													<div class="form-group form-floating-label">
														<label>القريه</label>
														<input type="text" value="<?php echo $row['villag']; ?>" class="form-control input-border-bottom" id="inputFloatingLabel" name="villag">
													</div>
													<div class="form-group form-floating-label">
													...
													<div class="form-group form-floating-label">
														...
														<select class="selectpicker form-control" id="tokens ddd" data-live-search="true" name="plasce_from_come">
															...
															<option <?php if ($row['plasce_from_come'] == "لحج") echo "selected" ?>>لحج </option>
														</select>
													</div>
													<div class="form-group form-floating-label">
												...
												<div class="col-md-6 col-lg-4">
													...
													<?php if ($_SESSION['user']['branch_id'] == 6) { ?>
														<div class="form-group form-floating-label">
															...
															<select class="selectpicker form-control" multiple id="tokens ddd" data-live-search="true" name="project[]">
