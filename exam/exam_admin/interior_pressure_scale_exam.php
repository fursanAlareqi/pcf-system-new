  ...
  <section id="container" >
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>مقياٌس وجهة الضبط الداخلي والخارجي</h3>
				<div class="row">
                  ...
                  <div class="col-md-12">
                      ...
                      <button class="hh" onclick="exportTableToExcel('tblData')">Export To Excel </button>
                          <table id="tblData"  class="table table-striped table-advance table-hover">
                              ...
                              <tbody>
                              <?php $ret=mysqli_query($con,"select * from interior_pressure_scale_exam where   (branch ='$branch')");
							  $cnt=1;
                              ...
                              <td><?php echo $cnt;?></td>
                                  ...
                                  <td><?php echo $row['exam_markes'];?></td>
