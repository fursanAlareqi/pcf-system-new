  ...
  <section id="container" >
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>اختبار ايزنك </h3>
				<div class="row">
                  ...
                  <div class="col-md-12">
                      ...
                      <a href="export1.php"><button type="button" class="hh">Export to Excle</button></a>
                          <table  class="table table-striped table-advance table-hover">
                              ...
                              <tbody>
                              <?php $ret=mysqli_query($con,"select * from ezenk_exam");
							  $cnt=1;
                              ...
                              <td><?php echo $cnt;?></td>
                                  ...
                                  <td><?php echo $row['antoa'];?></td>
                                  <td><?php echo $row['laier'];?></td>
