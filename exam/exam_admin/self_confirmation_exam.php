  ...
  <section id="container" >
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>مقياس تاكيد الذات من الاختبارات الستة</h3>
				<div class="row">
                  ...
                  <div class="col-md-12">
                      ...
                      <button class="hh" onclick="exportTableToExcel('tblData')">Export To Excel </button>
                          <table id="tblData"  class="table table-striped table-advance table-hover">
                              ...
                              <tbody>
                              <?php $ret=mysqli_query($con,"select * from self_confirmation_exam  where   (branch ='$branch')");
							  $cnt=1;
